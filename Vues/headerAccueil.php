<script src="Vues/ScriptJS.js" type="text/javascript"></script>
<?php 
if (session_status()!= 2){
    session_start(); 
}?>
    ...
    <body>
        <div class="navBar">
            <div class="linkNavBar">
                <a href="index.php?uc=accueil&choix=index" class="linkSelected">Accueil</a>
                ...
                <a href="index.php?uc=pageEleve&choix=eleve" class="link">Élèves</a>
            </div>
